...
const MONITORED_APPS = [ // 格式: {url: "应用URL", name: "应用名称"}
  {url: "https://s0.cfapps.ap21.hana.ondemand.com", name: "s0"},  
    ...
    return `
      <div class="status-card ${statusClass}">
        ...
        <div class="card-body">
          ...
          <p><strong>URL:</strong> <a href="${app.url}/sub" target="_blank">${app.url}</a></p>
        </div>
      </div>
    `;
  }).join('');
